  ...
  return (
    <div className="bg-light-VeryLightGray h-screen">
      <div className="bg-top bg-gradient-to-r from-gradients-b to-gradients-a max-h-60">
        <div
          id="mainContainer"
          className="mx-5 md:w-8/12 md:mx-auto max-w-screen-lg"
        >
          <h1 className="pt-10 mb-4 text-left text-4xl tracking-widest font-bold text-light-VeryLightGray">
            TASKIE
          </h1>
          <div>
          ...
          <div
            id="taskList"
            className="bg-white mt-10 max-h-screen rounded-md shadow-md"
          >
            <TaskList
              tasks={tasks}
